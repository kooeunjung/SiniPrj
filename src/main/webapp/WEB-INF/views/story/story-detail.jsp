...
<main id="main"> <!-- <div class="wrapper bgded overlay" style="background-image:url('../images/demo/backgrounds/02.png');">
	...
	<div class="content">
		...
		<div class="scrollable">
			<table class="table table-striped">
				<%-- <c:foreach var="noti" items="${model.getNotice()}"> --%>

				<tbody>
					<tr>
						<th>제목</th>
						<%-- <td><%=((NoticeView).getAttribute("n")).getTitle()%></td> --%>
						<td>${storydetail.story.title}</td>
					</tr>
					<tr>
						<th>작성자</th>
						<%-- 	<td><%=n.getWriter()%></td> --%>
						<td>${storydetail.story.memberId}</td>
					</tr>
					<tr>
						<th>내용</th>
						<%-- <td><%=n.getRegDate()%></td> --%>
						<td>${storydetail.story.content}</td>
					</tr>
					<tr>
						<th>등록일</th>
						<%-- <td><%=n.getHit()%></td> --%>
						<td>${storydetail.story.regDate}</td>
					</tr>
